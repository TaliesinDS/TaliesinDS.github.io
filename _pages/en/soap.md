...
On this page, I share my experiences with making handmade soap, designing packaging, and optimizing the production process. I am not an expert, but I enjoy experimenting with different recipes, techniques, and materials. Here you can read about my discoveries, successes, and sometimes failures while learning and trying things out. Whether it's finding the right ingredients, testing new shapes, or coming up with creative packaging, I am happy to take you along on my personal learning journey and experiments with artisanal soap.
